...
import { ref, computed, reactive, toRefs, watch,onMounted,onUnmounted } from "vue";  //torefs 响应式函数onMounted,onUpdated,onRenderTriggered,
interface Dp {
  count: number;
  double: number;
  increase: () => void;
