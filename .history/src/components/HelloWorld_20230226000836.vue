...
import useURLloader from '../hooks/useURLloader'    //获得外部函数
...
export default defineComponent({
  ...
  setup() {
    const { x, y } = ()
     const { loaded, loading, result } = useMousePosition()
   // onMounted(()=>{   //加载
    ...
    const {  loaded, loading, result } = useURLloader('https://dog.ceo/api/breeds/image/random');
